...
import { useSetPasswordHook } from "../hooks/useSetPassword";
import { IParamsType } from "../types";
import { setPasswordValidationSchema } from "../schema";

export default function BodySetPassword({ params }: { params: Promise<IParamsType> }) {
