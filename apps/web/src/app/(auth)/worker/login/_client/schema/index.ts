...
const loginAdminValidationSchema = object().shape({
    email: string()
    ...
    password: string().min(8, 'Password minimal 8 karakter').required('Password harap diisi!')
})
export { loginAdminValidationSchema }