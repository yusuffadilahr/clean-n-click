...
import { useResendEmailWorkerHook } from "../hooks/useResendEmail";
import { resendEmailValidationSchema } from "../schema";

export default function BodyResendEmail() {
                ...
                <div className="flex flex-col absolute inset-0 h-full px-10 items-center justify-center w-full">
                    ...
                    <div className="flex w-full my-2 z-20 justify-between items-center">
                        <div className="flex items-center gap-1 text-sm">
                            ...
                            <Link href='/worker/login' className="text-blue-500 hover:text-blue-700">Login</Link>
                        </div>
                    </div>
                </div>
            </section>
