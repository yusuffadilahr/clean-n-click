...
export const PickupForm = ({ dataOrderType, dataOrderTypeLoading, dataNearestStoreLoading, setOpenDialog, dataMainAddressLoading, dataNearestStore, dataMainAddress, selectedAddress, handlePickupRequest, pickupValidationSchema, PendingPickupSubmit, isDisabledSucces }: IPickupFormProps) => (
    <Formik
        enableReinitialize
        initialValues={{
