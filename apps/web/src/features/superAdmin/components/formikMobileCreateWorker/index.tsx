...
export default function FormikCreateWorkerMobile({ getDataStore, isPending, handleCreateUser, setIsValuePhoneNumber, isValuePhoneNumber }: IFormikCreateWorkerMobile) {
    return (
        <Formik
            initialValues={{
                email: '',
